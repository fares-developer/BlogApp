...
//Crearemos una extensión funtion que nos ayuda a transformar un lista MovieEntity a Movie

fun List<MovieEntity>.toMovieList(): MovieList {
    val resultList = mutableListOf<Movie>()
    //Ahorra transformamos cada una de la películas
...
//Transformamos un movieEntity a Movie
